...
public class TC_ID_005_Transaction_Analysis_TestCase extends Driver_Setup{
	...
	public boolean TC_TestCaseName() throws Throwable {
		try {						
			...
			{				
					...
					if(MA_panel.Home_LHS_Dashboard(AirPay_Payment_MA_Panel_PageObject.TransactionAnalysis)==true)
					{
						Extent_Reporting.Log_Pass("Home Menu Is exist", "Passed");
						Extent_Reporting.Log_report_img("Home Menu", "Passed", driver);
					}else{
